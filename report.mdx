...
<img width="800" src="/images/reportfig1.webp" />
...
| kgCO2eq of device embodied emissions | User Device embodied emissions (kgCO2eq) |
| kgCO2eq of delivery network transmission | Network transmission emissions for delivery (kgCO2eq) |
| kgCO2eq of delivery datacenter | Datacenter emissions for delivery (kgCO2eq) |
| kgCO2eq of device usage | Device usage emissions for delivery and rendering (kgCO2eq) |
| kWh of delivery network transmission | Electricity consumption of network for delivery (kWh) |
| kWh of delivery datacenter | Electricity consumption of datacenter for delivery (kWh) |
| kWh of device usage | Electricity consumption of device for delivery and render (kWh) |
