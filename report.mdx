...
| total_kgco2eq_devicemanufacturing | User Device embodied emissions (kgCO2eq) |
| total_kgco2eq_connection_delivery | Network transmission emissions for delivery (kgCO2eq) |
| total_kgco2eq_datacenter_delivery | Datacenter emissions for delivery (kgCO2eq) |
| total_kgco2eq_device_delivery | Device usage emissions for delivery and rendering (kgCO2eq) |
| total_kwh_connection_delivery | Electricity consumption of network for delivery (kWh) |
| total_kwh_datacenter_delivery | Electricity consumption of datacenter for delivery (kWh) |
| total_kwh_device_delivery | Electricity consumption of device for delivery (kWh) |
