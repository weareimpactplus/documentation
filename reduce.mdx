...
Reduction:
1. On a more macro level - **Looking at one scope vs. a baseline** to determine the overall
reduction (can be done by brand, country, platform etc)
2. On a more micro level - **Assessing the impact of an optimisation** to determine the
