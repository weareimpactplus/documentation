...
<Note>Reduction and avoided emissions analyses require a lot of processing to compute so may take some time to run - this is normal behavior. For this reason, we run them asynchronously to allow you to continue navigating while the report runs and send a notification e-mail when it is complete. </Note>
...
<img width="600" src="/images/reducefig2.webp" />
