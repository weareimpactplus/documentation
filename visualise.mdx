---
title: Visualize
description: 'Selection of customisable dashboards to provide campaign information at a glance'
---
...
This section allow users to identify the some key details on the scope which was defined above
...
• ***Number of Platforms audited*** (giving an overview of the various channels on which the evaluation is done)
...
| **Targeting** | | Target Wi-Fi over cellcular | Target smaller screens |
...
It allows you to analyse your digital advertising activity by dimensions to identify the highest and lowest performers and context from an environmental standpoint in order to identify reduction actions.
...
- ***Performance metric*** determines which metric you wish to use as the basis of comaprison
